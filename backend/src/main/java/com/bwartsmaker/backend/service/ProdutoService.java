...
public class ProdutoService {
    ...
    public ProdutoEntity atualizarProduto(Long id, ProdutoEntity produtoAtualizado) {
        ...
        produtoExistente.setNome_prod(produtoAtualizado.getNome_prod());
        produtoExistente.setDesc_prod(produtoAtualizado.getDesc_prod());
        produtoExistente.setQntd_prod(produtoAtualizado.getQntd_prod());
        produtoExistente.setImg_prod(produtoAtualizado.getImg_prod());
        produtoExistente.setFrete_prod(produtoAtualizado.getFrete_prod());
        produtoExistente.setValor_prod(produtoAtualizado.getValor_prod());
